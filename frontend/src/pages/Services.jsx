  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 40, 100, 0.8), rgba(0, 60, 120, 0.85)), url(https://images.pexels.com/photos/380769/pexels-photo-380769.jpeg)`,
              ...
              return (
                <Card key={service.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <CardContent className="p-8 text-center">
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
