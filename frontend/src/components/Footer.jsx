          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href={`tel:${contactInfo.phone}`} className="text-gray-400 hover:text-blue-400 text-sm">
                  {contactInfo.phone}
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={18} className="text-blue-400 flex-shrink-0" />
                <a href={`mailto:${contactInfo.email}`} className="text-gray-400 hover:text-blue-400 text-sm">
                  {contactInfo.email}
                </a>
              </div>
            </div>
