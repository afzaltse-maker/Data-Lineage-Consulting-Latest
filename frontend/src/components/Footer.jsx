        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="hover:text-orange-500 transition-all cursor-pointer">Application Development</li>
              <li className="hover:text-orange-500 transition-all cursor-pointer">Data Management</li>
              <li className="hover:text-orange-500 transition-all cursor-pointer">Data Warehousing</li>
              <li className="hover:text-orange-500 transition-all cursor-pointer">Contract Staffing</li>
              <li className="hover:text-orange-500 transition-all cursor-pointer">Permanent Hire</li>
            </ul>
          </div>
